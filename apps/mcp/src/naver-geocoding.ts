...
/**
 * Checks whether runtime Naver credentials exist before adding user-visible geocoding warnings.
 */
...
/**
 * Reads only server runtime variables so Naver secrets never reach the widget payload.
 */
